...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{URL::to('/')}}/bower_components/admin-lte/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{URL::to('/')}}/bower_components/admin-lte/dist/css/skins/_all-skins.min.css">
  <!-- DataTables -->
  ...
  <link rel="stylesheet" href="{{URL::to('/')}}/bower_components/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<!-- jvectormap -->
<script src="{{URL::to('/')}}/bower_components/admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="{{URL::to('/')}}/bower_components/admin-lte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{URL::to('/')}}/bower_components/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<!-- AdminLTE App -->
<script src="{{URL::to('/')}}/bower_components/admin-lte/dist/js/adminlte.min.js"></script>
<!--  AdminLTE dashboard demo (This is only for demo purposes) -->
<!-- <script src="{{URL::to('/')}}/bower_components/admin-lte/dist/js/pages/dashboard.js"></script> -->
<!-- AdminLTE for demo purposes -->
<script src="{{URL::to('/')}}/bower_components/admin-lte/dist/js/demo.js"></script>
<!-- DataTables -->
...
<script type="text/javascript">
    $('#edit').on('show.bs.modal', function (event) {
        ...
        var studid = button.data('studid')
        var first_name = button.data('myfname')
        var last_name = button.data('mylname') 
        var mid_name = button.data('mymname') 
        ...
        modal.find('.modal-body #id').val(studid)
        modal.find('.modal-body #fname').val(first_name)
        modal.find('.modal-body #lname').val(last_name)
        modal.find('.modal-body #mname').val(mid_name)
...
<script type="text/javascript">
              $(document).ready(function(){ 
                      var div = $("#head");
                      div.animate({left: '30%'}, 300)
                      div.animate({fontSize: '2em'}, 500);
                      div.animate({color: 'green'});
              });
</script>
</body>
</html>
